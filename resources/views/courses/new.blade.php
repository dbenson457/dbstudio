        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @if (Auth::user() && Auth::user()->Role == 'Creator')
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">{{ __('Add New Course') }}</li>
                </ol>
            @else
                {{ __('My Courses') }}
            @endif
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg bg-blue-400">
                ...
                <p class="m-5 text-white">* Please fill in all details</p>
                        ...
                        <div class="shadow sm:rounded-md sm:overflow-hidden">
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select id="difficulty" name="difficulty" autocomplete="difficulty" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
